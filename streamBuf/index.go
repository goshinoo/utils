...
func (s * stream) eInt8(v interface{}) (err error) {
	//在offset处扩容数组
	s.buf = append(s.buf[:s.offset], append(make([]byte, 1), s.buf[s.offset:]...)...)
	err = encodeFunc(s.buf[s.offset:s.offset], s.endian, v)
	s.offset += 1
	return err
}
...
func (s * stream) eInt16(v interface{}) (err error) {
	s.buf = append(s.buf[:s.offset], append(make([]byte, 2), s.buf[s.offset:]...)...)
	err = encodeFunc(s.buf[s.offset:s.offset], s.endian, v)
	s.offset += 2
	return err
}
...
func (s * stream) eInt32(v interface{}) (err error) {
	s.buf = append(s.buf[:s.offset], append(make([]byte, 4), s.buf[s.offset:]...)...)
	err = encodeFunc(s.buf[s.offset:s.offset], s.endian, v)
	s.offset += 4
	return err
}
...
func (s * stream) eInt64(v interface{}) (err error) {
	s.buf = append(s.buf[:s.offset], append(make([]byte, 8), s.buf[s.offset:]...)...)
	err = encodeFunc(s.buf[s.offset:s.offset], s.endian, v)
	s.offset += 8
	return err
}
...
func (s * stream) eString(v interface{}) (err error) {
	...
	s.buf = append(s.buf[:s.offset], append(make([]byte, length), s.buf[s.offset:]...)...)
	str := []byte(*(v.(*string)))
	err = encodeFunc(s.buf[s.offset:s.offset], s.endian, &str)
	s.offset += length
	return err
}
